...
export HISTIGNORE="&:num:num :key:key :whatis*:whereis*rtr:rtr ::etr :etr:gs:gs :ga .:ga . :tmux:\r:ls:ls :pwd:pwd :ll:ll :cd:cd :cs:cs :la:la :so:so :vi:vi :bashrc:bashrc :trans :trans:..*"
